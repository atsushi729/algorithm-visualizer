                ...
                <tbody>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      The execution time of the algorithm is the same,
                      regardless of the size of the input data. An example is
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      The execution time of the algorithm increases
                      logarithmically with the input size. A common example is a
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      For instance, iterating through all elements in an array.
                    </td>
                  </tr>
                  <tr
                    className="border-b transition duration-300 ease-in-out hover:bg-neutral-100"
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      quadratic time, common in efficient sorting algorithms
                      like mergesort and heapsort.
                    </td>
                  </tr>
                  <tr
                    className="border-b transition duration-300 ease-in-out hover:bg-neutral-100"
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      The execution time is proportional to the square of the
                      input size. An example of this is the bubble sort
                      algorithm, where you might have to iterate through the
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      data set. Algorithms with exponential time complexity
                      become infeasible to run with larger inputs.
                    </td>
                  </tr>
                  <tr
                    className="border-b transition duration-300 ease-in-out hover:bg-neutral-100"
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      An example would be the brute-force solution to the
                      traveling salesman problem using permutation.
                    </td>
                  </tr>
                </tbody>
              </table>
